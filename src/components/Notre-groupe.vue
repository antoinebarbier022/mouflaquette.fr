  ...
  <div id="notre-groupe">
    ...
    <div class="texte-presentation-du-groupe">
        ...
        <TemplateTextImage v-for="event in historique" :key="event.id" 
                            :title="event.date" 
                            :text="event.text"
                            :image="event.urlImage" 
                            :positionImgRight="event.id%2"/><!-- pour alterner image/texte on prend l'index %2 qui nous donne 1 ou 0 pour true ou false-->
        ...
        components: {
            ...
            data(){
                return{
                    ...
                    ,textPresentation: "Groupe de musique électronique aux influences techno, dance et retro, Mouflaquettes est avant tout une bouffée d’énergie et de gaieté. Après avoir sorti un premier album, Bouquet subtil, en décembre 2018 et réalisé une série de concerts, nous avons produit un nouvel album, Velours, en septembre 2019. Depuis, nous préparons dans l’ombre un retour explosif marqué par la sortie de nouveaux titres et le lancement d’une nouvelle tournée. Tenez vous prêts, les Mouflaquettes arrivent …"
                    ,historique:
                        [
                            {   id:0,
                                date:"Avril 2018"
                                ,text:`Lors d’une soirée un peu arrosée, Paul nous lance au défi de rapper sur une instru random 
                                        ...
                                        Mouflaquettes.`
                                ,urlImage:"avril2018.jpg"
                            },
                            {   id:1,
                                date:"Juin 2018"
                                ,text:`Alors que l’idée de former un groupe de musique était restée au stade de « blague de soirée », 
                            ...
                            {   id:2,
                                ...
                                ,text:`Nous emménageons ensemble dans un grand appartement à Clermont-Ferrand. Dans cet appartement, 
                                        ...
                                        des LEDs. Ce studio deviendra notre terrier nous y passons tout notre temps libre.`
                                ,urlImage:"aout2018.jpg"
                            },
                            {   id:3,
                                date:"Décembre 2018"
                                ,text:`Après des mois de production intense, notre premier album sort. Nous lui donnons 
                                        le nom Bouquet Subtil. Fier de notre réalisation, nous fabriquons 100 exemplaires physique de 
                                ...
                                ,urlImage:"disques-decembre2018.jpg"
                            },
                            {   id:4,
                                date:"Janvier 2019"
                                ,text:`Nous atteignons les 50 équivalents ventes de notre album. Dans la foulée, nous recevons 
                                        ...
                                        notre nombre de ventes mais ne connaissons toujours pas la raison officielle 
                                        de cet évènement. Toujours est-il que nous pouvons dire que Bouquet Subtil est disque d’or.`
                                ,urlImage:"printemps-de-bourges-2019.jpg"
                            },
                            {   id:5,
                                date:"Mars 2019"
                            ...
                            {   id:6,
                                date:"Avril 2019"
                                ,text:`Nous participons au Printemps de Bourges. L’évènement est si énorme que jamais nous 
